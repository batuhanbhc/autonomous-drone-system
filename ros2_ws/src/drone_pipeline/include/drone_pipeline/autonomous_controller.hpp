...
private:
  struct Config
  {
    ...
    double camera_tilt_deg{55.0};
    double recent_half_life_seconds{5.0};
    double historic_half_life_seconds{60.0};
    double coverage_half_life_seconds{10.0};
    double search_phase_seconds{20.0};
    double blob_sigma{1.5};
    double ego_sigma{2.0};
    double people_count_normalizer{30.0};
    double count_map_compression_scale{3.0};
    double count_memory_historic_miss_penalty{0.5};
    double count_memory_decay_grace_period_seconds{10.0};
    ...
    int hotspot_suppression_radius_min_cells{4};
    ...
    bool include_shared_count_memory_staleness_channel{true};
  ...
  struct ObservationState
  {
    ...
    std::vector<float> shared_count_memory_staleness;
    ...
    std::vector<int32_t> people_count_last_visible_step;
    std::vector<int32_t> people_count_recent_last_visible_step;
  };
  ...
  bool include_shared_count_memory_staleness_channel_{true};
  bool include_instant_fov_channels_{true};
  bool enable_agent_ids_{true};
  ...
  std::uint64_t count_memory_decay_grace_steps_{0};
