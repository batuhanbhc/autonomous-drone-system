...
Actor and critic grids have different channel counts:
  - Actor grid  : (actor_grid_channels, H, W)  — 7 channels
  - Critic grid : (critic_grid_channels, H, W) — 6 + 2 * num_agents channels
                  (shared actor-style + per-drone instant/ego maps)
